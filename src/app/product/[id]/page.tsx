...
const productPage = async ({ params }: ProductPageProps) => {
    ...
    const originalPrice = product.price * 5; // simulation
             ...
             <div className="container mx-auto">
                ...
                <div className="flex flex-col items-center gap-2">
                    <p className="text-center text-red-500 text-sm md:text-base font-semibold animate-pulse">
                        ⚡️ Only {Math.floor(Math.random() * 10) + 1} items lef at this price!
                    </p>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2 mt-4">
                            ...
                            <div className="flex items-center gap-2 text-xs text-gray-600">
                                ...
                                <span>
                                    {/* Simulating stock availability from 50 to 70 */}
                                    {Math.floor(Math.random() * 50) + 20} people are viewing this product
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 mt-6 text-sm bg-white p-4 rounded-xl shadow-sm">
